...
- All writing follows `docs/guides/writing-style.md`: docs, guides, articles and blog posts, landing page and marketing copy, release notes, emails, UI copy, commit messages, code comments, and chat replies. The voice is a thoughtful engineer explaining what they learned while building real software: conversational, calm, precise, why before what, concrete examples, starting from a real problem. Engineering docs under `docs/` also follow the structure in `docs/guides/eng-doc-style.md`.
