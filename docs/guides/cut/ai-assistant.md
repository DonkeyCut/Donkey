...
| Tool catalog (117 tools) | ~140K chars (~35K tokens) | Claude/Codex: the MCP tool listing. Gemini: function declarations on each request. |
| Skills library (16 docs) | ~97K chars (~24K tokens) total | On demand only, via the list-skills and read-skill tools. |
