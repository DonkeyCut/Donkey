...
import { useResetSetting, useSaveSetting, type SettingRow } from "@/queries/settings";

// One registered setting, editable. The value on screen is what the product
// reads for everyone outside an experiment; Reset returns it to the default
// declared in code. Every su page that shows settings draws them with this.
export function SettingCard({ row }: { row: SettingRow }) {
