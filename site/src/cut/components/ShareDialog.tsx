...
import { Check, ChevronDown, Globe, Link as LinkIcon, Loader2, Lock, X } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-sm">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                className="w-full rounded-lg border border-input bg-transparent px-2.5 py-2 text-[12.5px] outline-none focus:border-ring"
                type="email"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center gap-2 rounded-lg border border-input px-2.5 py-2 text-left text-[12.5px] transition-colors hover:border-ring">
        ...
        {!loading && (
          <DialogFooter className="mt-1 flex-col gap-2 sm:flex-col">
            <Button className="w-full" disabled={saving} onClick={() => void copyLink()}>
              {copied ? (
                <>
