...
export const CUT_ROUTES: CutRoute[] = [
  ...
  { method: "PUT", path: "/api/cut/projects/folders/:id", handler: (req, p) => projectsApi.updateFolder(req, { id: p.id }) },
  ...
  { method: "POST", path: "/api/cut/library/templates/import", handler: (req) => libraryApi.importTemplate(req) },
