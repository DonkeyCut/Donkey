...
**Then the motion.** set_overlay_animation carries the entrance, the exit, a loop, and what a line does while it holds; 0.3-0.6s reads as an entrance, and a per-letter style is what makes a card read as typed. set_overlay_keyframes when the move is a specific path. add_shape is the rest of the graphics: bars, cards, rules, a block of color behind a line.
