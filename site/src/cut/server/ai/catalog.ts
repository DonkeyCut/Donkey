...
export const AI_TOOLS: AiToolDef[] = [
  ...
  },
  {
    ...
    inputSchema: obj({
      ...
      aspect: { type: "string", enum: ["9:16", "16:9"], description: "Output shape (default: the supported shape closest to the project aspect)" },
...
Aspect: every shot renders at the plan's aspect, frozen from the project when approved. Shots render at 9:16 or 16:9 — a custom project ratio freezes the closest of the two and the shots letterbox in the frame. Check project.aspect first; when the user wants a specific format, set_aspect BEFORE approve_scene. Changing aspect after approval re-renders nothing.
...
- Times are seconds. The frame follows project.aspect in editor_state — any "W:H" ratio, short side 1080px; project.frame has the exact pixels.
